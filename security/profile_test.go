...
func TestProfileListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Security.Profiles.List(context.TODO(), security.ProfileListParams{
...
func TestProfileGet(t *testing.T) {
	...
	_, err := client.Security.Profiles.Get(context.TODO(), 0)
	if err != nil {
		var apierr *gcore.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestProfileRecreateWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Security.Profiles.Recreate(
		context.TODO(),
		0,
...
func TestProfileReplaceWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Security.Profiles.Replace(
		context.TODO(),
		0,
