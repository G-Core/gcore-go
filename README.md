...
```sh
go get -u 'github.com/G-Core/gcore-go@v0.1.0-alpha.1'
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/G-Core/gcore-go/issues) with questions, bugs, or suggestions.
