...
func TestAnalyticsGetRequestsWithOptionalParams(t *testing.T) {
	...
	_, err := client.Waap.Analytics.GetRequests(context.TODO(), waap.AnalyticsGetRequestsParams{
		...
		ExcludeJa3:               gcore.String("e7d705a3286e19ea42f587b344ee6865"),
		...
		ExcludeUserAgent:         gcore.String("python-requests"),
		...
		IPs:                      []string{"1.2.3.4", " 2001:678:194::3c25:ddad"},
		Ja3:                      gcore.String("e7d705a3286e19ea42f587b344ee6865"),
		Limit:                    gcore.Int(0),
		Offset:                   gcore.Int(0),
		...
		UserAgent:                gcore.String("Mozilla/5.0"),
