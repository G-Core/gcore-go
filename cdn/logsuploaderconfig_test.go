...
func TestLogsUploaderConfigNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.CDN.LogsUploader.Configs.New(context.TODO(), cdn.LogsUploaderConfigNewParams{
		...
		ForAllResources: gcore.Bool(true),
		Resources:       []int64{0},
	})
	if err != nil {
...
func TestLogsUploaderConfigUpdateWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestLogsUploaderConfigListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestLogsUploaderConfigDelete(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestLogsUploaderConfigGet(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestLogsUploaderConfigReplaceWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestLogsUploaderConfigValidate(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
