...
func (r *GPUBaremetalClusterImageService) List(ctx context.Context, params GPUBaremetalClusterImageListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[GPUImage], err error) {
...
// List bare metal GPU images
func (r *GPUBaremetalClusterImageService) ListAutoPaging(ctx context.Context, params GPUBaremetalClusterImageListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[GPUImage] {
