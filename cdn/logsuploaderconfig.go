...
func (r *LogsUploaderConfigService) List(ctx context.Context, query LogsUploaderConfigListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[LogsUploaderConfig], err error) {
...
// Get list of logs uploader configs.
func (r *LogsUploaderConfigService) ListAutoPaging(ctx context.Context, query LogsUploaderConfigListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[LogsUploaderConfig] {
...
type LogsUploaderConfigList struct {
...
// Returns the unmodified JSON received from the API
func (r LogsUploaderConfigList) RawJSON() string { return r.JSON.raw }
func (r *LogsUploaderConfigList) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
