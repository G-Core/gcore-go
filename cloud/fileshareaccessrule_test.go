...
func TestFileShareAccessRuleNew(t *testing.T) {
	...
	_, err := client.Cloud.FileShares.AccessRules.New(
		context.TODO(),
...
func TestFileShareAccessRuleList(t *testing.T) {
	...
	_, err := client.Cloud.FileShares.AccessRules.List(
		context.TODO(),
		"bd8c47ee-e565-4e26-8840-b537e6827b08",
...
func TestFileShareAccessRuleDelete(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
