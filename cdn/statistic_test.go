...
func TestStatisticGetLogsUsageAggregatedWithOptionalParams(t *testing.T) {
...
func TestStatisticGetLogsUsageSeriesWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestStatisticGetResourceUsageAggregatedWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Cdn.Statistics.GetResourceUsageAggregated(context.TODO(), cdn.StatisticGetResourceUsageAggregatedParams{
		...
		Service:   "service",
		To:        "to",
		Countries: gcore.String("countries"),
		Flat:      gcore.Bool(true),
		GroupBy:   gcore.String("group_by"),
		Regions:   gcore.String("regions"),
		Resource:  gcore.Int(0),
	})
	if err != nil {
		var apierr *gcore.Error
...
func TestStatisticGetResourceUsageSeriesWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestStatisticGetShieldUsageAggregatedWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestStatisticGetShieldUsageSeriesWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
