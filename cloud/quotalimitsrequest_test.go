...
func TestQuotaLimitsRequestNewWithOptionalParams(t *testing.T) {
	...
	err := client.Cloud.Quotas.LimitsRequest.New(context.TODO(), cloud.QuotaLimitsRequestNewParams{
		LimitsRequestCreate: cloud.LimitsRequestCreateParam{
			Description: "Scale up mysql cluster",
			RequestedLimits: cloud.LimitsRequestCreateRequestedLimitsParam{
				GlobalLimits: cloud.LimitsRequestCreateRequestedLimitsGlobalLimitsParam{
				...
				RegionalLimits: []cloud.LimitsRequestCreateRequestedLimitsRegionalLimitParam{{
...
func TestQuotaLimitsRequestGet(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Cloud.Quotas.LimitsRequest.Get(context.TODO(), "request_id")
	if err != nil {
		var apierr *gcore.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestQuotaLimitsRequestListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Cloud.Quotas.LimitsRequest.List(context.TODO(), cloud.QuotaLimitsRequestListParams{
...
func TestQuotaLimitsRequestDelete(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Cloud.Quotas.LimitsRequest.Delete(context.TODO(), "request_id")
	if err != nil {
		var apierr *gcore.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
