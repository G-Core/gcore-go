...
func (r *LoadBalancerFlavorService) List(ctx context.Context, params LoadBalancerFlavorListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[LoadBalancerFlavorListResultUnion], err error) {
...
// parameter is specified, the list shows prices. A client in trial mode gets all
// price values as 0. If you get Pricing Error contact the support
func (r *LoadBalancerFlavorService) ListAutoPaging(ctx context.Context, params LoadBalancerFlavorListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[LoadBalancerFlavorListResultUnion] {
