...
type InstanceImageListParams struct {
	...
	//
	// Any of "aarch64", "x86_64".
	Architecture InstanceImageListParamsArchitecture `query:"architecture,omitzero" json:"-"`
...
// Filter by image architecture.
type InstanceImageListParamsArchitecture string

const (
	InstanceImageListParamsArchitectureAarch64 InstanceImageListParamsArchitecture = "aarch64"
	InstanceImageListParamsArchitectureX86_64  InstanceImageListParamsArchitecture = "x86_64"
)
